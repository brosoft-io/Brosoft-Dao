...
import cucumber.dao.postgres.PostgresAnimeDao;
...
public class PostgresqlFeature {
	...
	public void a_Postgresql_DB_with_an_anime_table() throws ExecutionException {
		animeDao = new PostgresAnimeDao();
	...
	public void an_anime_was_inserted_into_the_Postgresql_DB_anime_table() throws ExecutionException {
		anime1 = new Anime();
	...
	public void the_anime_is_updated_in_the_Postgresql_DB() throws ExecutionException {
		anime2 = new Anime();
	...
	public void the_change_should_be_persistent_in_the_Postgresql_DB() throws ExecutionException {
	...
	@Then("the anime should be deleatable from the Postgresql DB")
	public void the_anime_should_be_deleatable_from_the_Postgresql_DB() throws ExecutionException {
